...
> extends Agent<Observation, Action> {
  ...
  public prepareMiniBatch() {
    ...
    if (this.miniBatchData) {
      this.miniBatchData.obs.dispose();
      this.miniBatchData.mask.dispose();
      this.miniBatchData.act.dispose();
      this.miniBatchData.ret.dispose();
      this.miniBatchData.adv.dispose();
      this.miniBatchData.logp.dispose();
    }
    this.miniBatchData = this.buffer.get();
    if (this.miniBatchIndices) {
      this.miniBatchIndices.dispose();
    }
